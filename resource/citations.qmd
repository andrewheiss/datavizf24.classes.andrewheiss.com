...
You can access [a shared group Zotero library of all the non-web-based class reading references](https://www.zotero.org/groups/datavizf24) and link it to your Zotero account to easily cite the course materials. 
...
<a class="btn btn-danger" target="_blank" href="https://www.zotero.org/groups/datavizf24">{{< ai zotero color=white >}}&ensp;Zotero group library</a> &ensp;
