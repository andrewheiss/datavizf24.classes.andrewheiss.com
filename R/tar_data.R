...
save_data <- list(
  ...
  # https://datavizf24.classes.andrewheiss.com/exercise/08-exercise.html#postscript-how-i-got-this-unemployment-data
...
set_up_python <- function() {
  library(reticulate)
  virtualenv_create("datavizf24")
  py_install("cleannlp", envname = "datavizf24")
}
...
tag_little_women <- function(raw_text) {
  ...
  # Use spaCy
  reticulate::use_virtualenv("datavizf24", required = TRUE)
