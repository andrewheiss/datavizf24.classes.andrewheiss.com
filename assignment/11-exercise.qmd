...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `11-exercise1.Rproj`: [{{< fa file-archive >}} `11-exercise.zip`](/projects/11-exercise.zip)
   ...
   (Alternatively, you can open the project named "Exercise 11" on Posit.cloud and complete the assignment in your browser without needing to install anything. [This link should take you to the project](https://posit.cloud/spaces/540349/content/8557019)—if it doesn't, log in and look for the project named "Exercise 11".)
