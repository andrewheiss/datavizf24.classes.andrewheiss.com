...
You'll need to create an RStudio Project folder to organize all your content, just like with all the previous exercises and mini projects.^[There's also [an empty Posit.Cloud project here](https://posit.cloud/spaces/540349/content/8557028) if you want.]
