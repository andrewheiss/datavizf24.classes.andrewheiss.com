...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `09-exercise.Rproj`: [{{< fa file-archive >}} `09-exercise.zip`](/projects/09-exercise.zip)
   ...
   (Alternatively, you can open the project named "Exercise 9" on Posit.cloud and complete the assignment in your browser without needing to install anything. [This link should take you to the project](https://posit.cloud/spaces/540349/content/8557017)—if it doesn't, log in and look for the project named "Exercise 9".)
