...
In the FAQs for sessions 5 and 6, [I showed how R has built-in variables for US state and region names](/news/2024-11-13_faqs_weeks-07-08.qmd#my-data-has-full-us-state-names-but-i-want-to-use-abbreviations-or-regions.-is-there-a-way-to-automatically-convert-from-names-to-something-else):
